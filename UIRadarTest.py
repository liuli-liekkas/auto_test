...
class RadarTestMain(QMainWindow):
	...
	def tab2_ui(self):
		...
		self.tab2_sample_number_label.setMaximumWidth(70)
		...
		self.tab2_tester_name_label.setMaximumWidth(70)
		...
		self.tab2_supervisor_name_label.setMaximumWidth(70)
		...
		self.tab2_test_data_label.setMaximumWidth(70)
